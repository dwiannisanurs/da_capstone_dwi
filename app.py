...
def route_avg_durations_by_bikeid(bike_id):
    conn = make_connection()
    avg_duration_bike = get_avg_duration_by_bikeid(json.dumps(bike_id), conn)
    return avg_duration_bike.to_json()
...
def period_date():
    ...
    conn = make_connection()
    trips_period = get_trips_by_period(specified_date, conn)
    return trips_period.to_json()
...
def get_trips_by_period(specified_date, conn):
    query = f"""
